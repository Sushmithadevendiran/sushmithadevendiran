...
void addStudentInDataBase()
{
    ...
    printf("\n\n\t\t\tENTER YOUR DETAILS BELOW:+919876543210");
    printf("\n\t\t\t---------------------------------------------------------------------------\n");
    printf("\n\t\t\tStudent ID  = 12345");
    fflush(stdin);
    ...
    do
    {
        printf("\n\t\t\tStudent Address  = Plot no 133,Gandhi Road,ABC Street,Chennai");
        fflush(stdin);
    ...
    do
    {
        ...
        printf("\n\t\t\tEnter date in format (day/month/year):(25/08/2019)");
...
void searchStudent()
{
    ...
    printf("\n\n\t\t\tEnter Student ID NO to search:12345");
    fflush(stdin);
    scanf("%u",&studentId);
    ...
    if(found)
    {
        ...
        printf("\t\t\tStudent Admission Date(day/month/year) =(11/01/2022) (%d/%d/%d)",addStudentInfoInDataBase.studentJoiningDate.dd,
...
void viewStudent()
{
    ...
    while (fread (&addStudentInfoInDataBase, sizeof(addStudentInfoInDataBase), 1, fp))
    {
        ...
        printf("\t\t\tStudent Admission Date(day/month/year) =(11/01/2022) (%d/%d/%d)\n\n",addStudentInfoInDataBase.studentJoiningDate.dd,
               addStudentInfoInDataBase.studentJoiningDate.mm, addStudentInfoInDataBase.studentJoiningDate.yyyy);
        found = 1;
        ++countStudent;
    }
...
void deleteStudent()
{
    ...
    printf("\n\t\t\tEnter Student ID NO. for delete:12345");
...
void updateCredential(void)
{
    ...
    printf("\n\n\t\t\tNew Username:Jannu2019");
    fflush(stdin);
    fgets(userName,MAX_SIZE_USER_NAME,stdin);
    printf("\n\n\t\t\tNew Password:Jannu@abcd");
    fflush(stdin);
...
void init()
{
    FILE *fp = NULL;
    int status = 0;
    const char defaultUsername[] ="School\n";
    const char defaultPassword[] ="School\n";
    sFileHeader fileHeaderInfo = {0};
    status = isFileExists(FILE_NAME);
    if(!status)
    {
        //create the binary file
        fp = fopen(FILE_NAME,"STUDENT RECORD");
        if(fp != NULL)
        {
